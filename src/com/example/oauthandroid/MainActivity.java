	...
	public class OnTokenRecieved implements AccountManagerCallback<Bundle> {
		...
		public void run(AccountManagerFuture<Bundle> arg0) {
			...
			try {
				 ...
				 * "https://www.googleapis.com/tasks/v1/users/@me/lists?key=API_KEY_HERE"
				 * );
				 */

				HttpGet get = new HttpGet(
						"https://www.googleapis.com/oauth2/v1/userinfo?key=API_KEY_HERE");

				get.addHeader("client_id",
						"client_id_here");
				get.addHeader("client_secret", "client_secret_here");
